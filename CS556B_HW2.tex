...
\begin{enumerate}
    ...
    $\mathbf{ A = \bigvee \bigwedge \bigvee^{-1} = \begin{bmatrix} 1 & -1 \\ -2 & 1 \end{bmatrix} \begin{bmatrix} 5 & 0 \\ 0 & -1 \end{bmatrix} \begin{bmatrix} -1 & -1 \\ -2 & -1 \end{bmatrix} }$ \\
    $\mathbf{ \begin{bmatrix} 5 & 1 \\ -10 & -1 \end{bmatrix} \begin{bmatrix} -1 & -1 \\ -2 & -1 \end{bmatrix} = \begin{bmatrix} -7 & -6 \\ 12 & 11 \end{bmatrix} }$
